...
/**
 * Elementor redlight-button Widget.
 *
 * Elementor widget that uses the button control.
 *
 * @since 1.0.0
 */
class Elementor_Redlight_Button_Widget extends \Elementor\Widget_Base {

	/**
	 * Get widget name.
	 *
	 * Retrieve redlight-button widget name.
	 *
	 * @since 1.0.0
	 * @access public
	 ...
	 * Get widget title.
	 *
	 * Retrieve redlight-button widget title.
	 *
	 * @since 1.0.0
	 * @access public
	...
	public function get_title() {
		return esc_html__( 'Redlight Button', 'elementor-redlight-button-control' );
	}

	/**
	 * Get widget icon.
	 *
	 * Retrieve redlight-button widget icon.
	 *
	 * @since 1.0.0
	 * @access public
	...
	/**
	 * Register redlight-button widget controls.
	 *
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'content_section',
			[
				'label' => esc_html__( 'Content', 'elementor-redlight-button-control' ),
		...
		$this->add_control(
			'ai_button_text',
			[
				'label' => esc_html__( 'Button Text', 'elementor-redlight-button-control' ),
				'label_block' => true,
				'placeholder' => __( 'Read More', 'elementor-redlight-button-control' ),
				'default' => __( 'Read More' , 'elementor-redlight-button-control' ),
				'type' => 'text',
			]
		);
		$this->add_control(
			'ai_button_link',
			[
				'label' => esc_html__( 'Button Link', 'elementor-redlight-button-control' ),
				'label_block' => true,
				'placeholder' => __( '#', 'elementor-redlight-button-control' ),
				'default' => __( '#' , 'elementor-redlight-button-control' ),
				'type' => 'text',
			]
		);
		$this->add_responsive_control(
			'alignment',
			[
			'label' => esc_html__( 'Alignment', 'elementor-redlight-button-control' ),
			'type' => \Elementor\Controls_Manager::CHOOSE,
			'options' => [
				'left' => [
					'title' => esc_html__( 'Left', 'elementor-redlight-button-control' ),
					'icon' => 'eicon-text-align-left',
				],
				'center' => [
					'title' => esc_html__( 'Center', 'elementor-redlight-button-control' ),
					'icon' => 'eicon-text-align-center',
				],
				'right' => [
					'title' => esc_html__( 'Right', 'elementor-redlight-button-control' ),
	...
	/**
	 * Render redlight-button widget output on the frontend.
	 *
